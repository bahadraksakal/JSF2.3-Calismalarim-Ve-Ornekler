...
@FacesConverter("SiteAdresiTamamlamaSinifiConverter")
//f converterin içinde yukarıda yazan isim ile çağırıcaz bunu
...
@Override
 public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if (!urlValidator.isValid(url.toString())) {
            ...
            FacesMessage mesaj = new FacesMessage("URL tamamlama hatası.", "Geçersiz URL girildi.");
            mesaj.setSeverity(FacesMessage.SEVERITY_ERROR);
            url.append("   ! BÖYLE BİR SAYFA YOK");
